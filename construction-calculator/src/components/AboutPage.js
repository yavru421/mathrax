        ...
        <div className="p-8 bg-gradient-to-r from-primary-teal to-accent-blue">
          <div className="text-white space-y-8">
            ...
            <div className="text-center mb-12">
              <h1 className="text-6xl font-black mb-4">MATHRAX</h1>
            ...
            <div className="bg-white/10 rounded-xl p-6 backdrop-blur-sm">
              ...
              <p className="text-sm text-white/80 mb-4">
                MATHRAX™ and all related software, designs, and content are registered trademarks and intellectual property of 
            ...
            <div className="text-center text-white/60 text-sm pt-8">
              <p className="flex items-center justify-center gap-2">
                Made with <span className="font-mono text-cyan-400">JD's_CPU</span> in MATHRAX Labs
              </p>
            </div>
          </div>
        </div>
